...
export function createPopOps() {
    ...
    createPopOp('trace', {
        ...
        step: 'camTraceOver',
        down: 'camTraceDown',
        continuous: 'camTraceContinuous',
        cont_top: 'camTraceContTop',
        cont_bottom: 'camTraceContBottom',
        thru: 'camTraceThru',
        rate: 'camTraceSpeed',
        ...
        continuous: UC.newBoolean(LANG.cc_cont_s, undefined, { title: LANG.cc_cont_l, show: () => env.poppedRec.mode === 'follow' }),
        cont_top: UC.newBoolean(LANG.cc_ctop_s, undefined, { title: LANG.cc_ctop_l, show: () => env.poppedRec.mode === 'follow' && env.poppedRec.continuous }),
        cont_bottom: UC.newBoolean(LANG.cc_cbot_s, undefined, { title: LANG.cc_cbot_l, show: () => env.poppedRec.mode === 'follow' && env.poppedRec.continuous }),
