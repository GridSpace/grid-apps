...
export function createPopOps() {
    ...
    createPopOp('rough', {
        ...
        sep: UC.newBlank({ class: "pop-sep" }),
        all: UC.newBoolean(LANG.cr_clst_s, undefined, { title: LANG.cr_clst_l, show: () => !env.poppedRec.inside }),
        inside: UC.newBoolean(LANG.cr_olin_s, undefined, { title: LANG.cr_olin_l, show: () => !env.poppedRec.all }),
