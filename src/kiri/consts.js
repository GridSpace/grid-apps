...
gapp.register('kiri.consts', (root, exports) => {
  ...
  const LISTS = {
    ...
    detail: [{ name: '100' }, { name: '75' }, { name: '50' }, { name: '25' }],
    linetype: [{ name: 'path' }, { name: 'flat' }, { name: 'line' }],
    animesh: [
      { name: '100' },
      { name: '200' },
      { name: '300' },
    ...
    trace: [{ name: 'follow' }, { name: 'clear' }],
    traceoff: [{ name: 'none' }, { name: 'inside' }, { name: 'outside' }],
    zanchor: [{ name: 'top' }, { name: 'middle' }, { name: 'bottom' }],
    xyaxis: [{ name: 'X' }, { name: 'Y' }],
    regaxis: [{ name: 'X' }, { name: 'Y' }, { name: '-' }],
