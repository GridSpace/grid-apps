...
gapp.register("kiri.init", [], (root, exports) => {
    ...
    function init_one() {
        ...
        Object.assign(ui, {
            ...
            outputFanLayer:      uc.newInput(LANG.ou_fanl_s, {title:LANG.ou_fanl_l, convert:uc.toInt, bound:uc.bound(0,255), modes:FDM}),
            fdmSep:              uc.newBlank({class:"pop-sep", modes:FDM}),
            ...
            firstLayerFanSpeed:  uc.newInput(LANG.ou_fans_s, {title:LANG.ou_fans_l, convert:uc.toInt, bound:uc.bound(0,255), modes:FDM, show:isBelt}),
            fdmSep:              uc.newBlank({class:"pop-sep", modes:FDM, show:isNotBelt}),
            ...
            camSep:              uc.newBlank({class:"pop-sep", modes:CAM, show:() => !ui.camStockIndexed.checked}),
            ...
            laserLayout:         uc.newGroup(LANG.lo_menu, null, {modes:LASER}),
            ...
            camOrigin:           uc.newGroup(LANG.co_menu, null, {modes:CAM}),
