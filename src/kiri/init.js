...
gapp.register("kiri.init", [], (root, exports) => {
    ...
    function init_one() {
        ...
        Object.assign(ui, {
            ...
            separator:           newBlank({ class:"set-sep", driven, modes:WEDM }),
            ctOriginOffX:        newInput(LANG.or_offx_s, {title:LANG.or_offx_l, convert:toFloat, modes:WEDM}),
            ctOriginOffY:        newInput(LANG.or_offy_s, {title:LANG.or_offy_l, convert:toFloat, modes:WEDM}),
