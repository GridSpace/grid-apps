...
gapp.register("kiri.init", [], (root, exports) => {
    ...
    function init_one() {
        ...
        Object.assign(ui, {
            ...
            separator:        newBlank({class:"set-sep", modes:FDM, driven:true}),
            _____:            newGroup(LANG.dv_gr_too, $('device2'), {group:"dext", inline:true, modes:CAM_LZR}),
            ...
            _____:            newGroup(LANG.dv_gr_out, $('device2'), {group:"dgco", inline:true, modes:CAM_LZR}),
