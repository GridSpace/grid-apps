...
gapp.register("kiri.init", [], (root, exports) => {
    ...
    function init_one() {
        ...
        let { newInput2, newSelect, newText, newRow, newGCode } = uc;
        ...
        Object.assign(ui, {
            ...
            device:           newGroup(LANG.dv_gr_dev, $('device1'), {group:"ddev", inline:true, class:"noshow"}),
            deviceName:       newInput(LANG.dv_name_s, {title:LANG.dv_name_l, size:"70%", text:true, action:updateDeviceName}),

            devbed:           newRow([
                uc.newLabel(LANG.volume, { class: "grow" }),
                uc.newLabel('X'),
                ui.bedWidth   = newInput2({title:LANG.dv_bedw_l, convert:toFloat, size:5, units:true, round:2, action:updateDeviceSize}),
                uc.newLabel('Y'),
                ui.bedDepth   = newInput2({title:LANG.dv_bedd_l, convert:toFloat, size:5, units:true, round:2, action:updateDeviceSize}),
                uc.newLabel('Z'),
                ui.maxHeight  = newInput2({title:LANG.dv_bedh_l, convert:toFloat, size:5, modes:FDM_SLA, action:updateDeviceSize}),
            ], { class: "var-area" }),

            resolutionX:      newInput(LANG.dv_rezx_s, {title:LANG.dv_rezx_l, convert:toInt, size:5, modes:SLA}),
            resolutionY:      newInput(LANG.dv_rezy_s, {title:LANG.dv_rezy_l, convert:toInt, size:5, modes:SLA}),
            ...
            separator:        newBlank({class:"pop-sep", modes:FDM}),
            filamentSource:   newSelect(LANG.dv_fsrc_s, {title: LANG.dv_fsrc_l, action: filamentSourceSave, modes:FDM}, "filasrc"),
            ...
            deviceRound:      newBoolean(LANG.dv_bedc_s, onBooleanClick, {title:LANG.dv_bedc_l, trigger:true, show:isNotBelt}),
            deviceBelt:       newBoolean(LANG.dv_belt_s, onBooleanClick, {title:LANG.dv_belt_l, trigger:true, show:() => !ui.deviceRound.checked}),

            extruder:         newGroup(LANG.dv_gr_ext, $('device2'), {group:"dext", inline:true, modes:FDM}),
            ...
            palette:          newGroup(LANG.dv_gr_pal, $('palette3'), {group:"dext2", inline:true, modes:FDM}),
            ...
            gcode:            newGroup(LANG.dv_gr_out, $('device2'), {group:"dgco", inline:true, modes:CAM_LZR}),
            ...
            lprefs:           newGroup(LANG.op_menu, $('prefs-gen1'), {inline: true}),
            ...
            lprefs:           newGroup(LANG.op_disp, $('prefs-gen2'), {inline: true}),
            ...
            export:           newGroup(LANG.xp_menu, $('prefs-xpo'), {inline: true}),
            ...
            parts:            newGroup(LANG.pt_menu, $('prefs-prt'), {inline: true}),
            ...
            process:             newGroup(LANG.sl_menu, $('fdm-layers'), { modes:FDM, driven }),
            sliceHeight:         newInput(LANG.sl_lahi_s, { title:LANG.sl_lahi_l, convert:toFloat }),
            sliceMinHeight:      newInput(LANG.ad_minl_s, { title:LANG.ad_minl_l, bound:bound(0,3.0), convert:toFloat, show: () => ui.sliceAdaptive.checked}),
            ...
            sliceAdaptive:       newBoolean(LANG.ad_adap_s, onBooleanClick, {title: LANG.ad_adap_l, trigger: true}),

            firstLayer:          newGroup(LANG.fl_menu, $('fdm-base'), { modes:FDM, driven }),
            ...
            fdmInfill:           newGroup(LANG.fi_menu, $('fdm-fill'), { modes:FDM, driven }),
            ...
            fdmSupport:          newGroup(LANG.sp_menu, $('fdm-support'), { modes:FDM, marker:false, driven }),
            ...
            sliceSupportSize:    newInput(LANG.sp_size_s, {title:LANG.sp_size_l, bound:bound(1.0,200.0), convert:toFloat}),
            sliceSupportOffset:  newInput(LANG.sp_offs_s, {title:LANG.sp_offs_l, bound:bound(0.0,200.0), convert:toFloat}),
            sliceSupportGap:     newInput(LANG.sp_gaps_s, {title:LANG.sp_gaps_l, bound:bound(0,5), convert:toInt}),
            sliceSupportArea:    newInput(LANG.sp_area_s, {title:LANG.sp_area_l, bound:bound(0.0,200.0), convert:toFloat}),
            sliceSupportExtra:   newInput(LANG.sp_xpnd_s, {title:LANG.sp_xpnd_l, bound:bound(0.0,10.0), convert:toFloat}),
            sliceSupportGrow:    newInput(LANG.sp_grow_s, {title:LANG.sp_grow_l, bound:bound(0.0,10.0), convert:toFloat}),
            sliceSupportAngle:   newInput(LANG.sp_angl_s, {title:LANG.sp_angl_l, bound:bound(0.0,90.0), convert:toFloat}),
            sliceSupportSpan:    newInput(LANG.sp_span_s, {title:LANG.sp_span_l, bound:bound(0.0,200.0), convert:toFloat, show:() => ui.sliceSupportEnable.checked}),
            separator:           newBlank({ class:"set-sep", driven }),
            ...
            fdmOutput:           newGroup(LANG.ou_menu, $('fdm-output'), { modes:FDM, driven }),
            ...
            fdmExpert:           newGroup(LANG.ad_menu, $('fdm-expert'), { modes:FDM, driven }),
            ...
            outputRetractWipe:   newInput(LANG.ad_wpln_s, {title:LANG.ad_wpln_l, bound:bound(0.0,10), convert:toFloat}),
            ...
            outputMinSpeed:      newInput(LANG.ad_mins_s, {title:LANG.ad_mins_l, bound:bound(1,200), convert:toFloat}),
            outputShortPoly:     newInput(LANG.ad_spol_s, {title:LANG.ad_spol_l, bound:bound(0,10000), convert:toFloat}),
            outputCoastDist:     newInput(LANG.ad_scst_s, {title:LANG.ad_scst_l, bound:bound(0.0,10), convert:toFloat}),
            zHopDistance:        newInput(LANG.ad_zhop_s, {title:LANG.ad_zhop_l, bound:bound(0,3.0), convert:toFloat}),
            arcTolerance:        newInput(LANG.ad_arct_s, {title:LANG.ad_arct_l, bound:bound(0,1.0), convert:toFloat, show:() => { return isNotBelt() }}),
            antiBacklash:        newInput(LANG.ad_abkl_s, {title:LANG.ad_abkl_l, bound:bound(0,3), convert:toInt}),
            ...
            camTabs:             newGroup(LANG.ct_menu, $('cam-tabs'), { modes:CAM, marker:true, driven }),
            ...
            camStock:            newGroup(LANG.cs_menu, $('cam-stock'), { modes:CAM, driven }),
            ...
            camLimits:           newGroup(LANG.cc_menu, $('cam-limits'), { modes:CAM, driven }),
            ...
            camOutput:           newGroup(LANG.ou_menu, $('cam-output'), { modes:CAM, driven }),
            ...
            camOrigin:           newGroup(LANG.co_menu, $('cam-origin'), { modes:CAM, driven }),
            ...
            camExpert:           newGroup(LANG.op_xprt_s, $('cam-expert'), { group: "cam_expert", modes:CAM, marker: false, driven }),
            ...
            laserMode:           newGroup(LANG.sl_menu, $('lzr-slice'), { modes:LASER, driven }),
            ...
            laserSliceHeightMin: newInput(LANG.ls_lahm_s, {title:LANG.ls_lahm_l, convert:toFloat, show:() => { return ui.laserSliceHeight.value == 0 }}),
            separator:           newBlank({ class:"set-sep", driven }),
            laserSliceSingle:    newBoolean(LANG.ls_sngl_s, onBooleanClick, {title:LANG.ls_sngl_l}),

            laserLayout:         newGroup(LANG.lo_menu, $('lzr-layout'), { modes:LASER, driven }),
            ...
            outputLaserGroup:    newBoolean(LANG.ou_grpd_s, onBooleanClick, {title:LANG.ou_grpd_l}),

            knife:               newGroup(LANG.dk_menu, $('lzr-knife'), { modes:LASER, marker:true, driven }),
            ...
            laserOutput:         newGroup(LANG.ou_menu, $('lzr-output'), { modes:LASER, driven }),
            ...
            slaProc:             newGroup(LANG.sa_menu, $('sla-slice'), { modes:SLA, group:"sla-slice", driven }),
            ...
            slaLayers:           newGroup(LANG.sa_layr_m, $('sla-layers'), { modes:SLA, group:"sla-layers", driven }),
            ...
            slaBase:             newGroup(LANG.sa_base_m, $('sla-base'), { modes:SLA, group:"sla-base", driven }),
            ...
            slaFill:             newGroup(LANG.sa_infl_m, $('sla-fill'), { modes:SLA, group:"sla-infill", driven }),
            ...
            slaSupport:          newGroup(LANG.sa_supp_m, $('sla-support'), { modes:SLA, group:"sla-support", driven }),
            ...
            slaOutput:           newGroup(LANG.sa_outp_m, $('sla-output'), { modes:SLA, group:"sla-first", driven }),
