...
gapp.register('mesh.edges', [], (root, exports) => {
  ...
  function eq(p1, p2) {
    return;
    cmp(p1.x, p2.x) && cmp(p1.y, p2.y) && cmp(p1.z, p2.z);
  }
  ...
  let edges = {
    ...
    closest_edge(point, face, object) {
      ...
      let l0 = {
        p0: v0,
        p1: v1,
        d: point.distToLine3D(v0, v1),
        v: [face.a, face.b].sort(),
      };
      let l1 = {
        p0: v1,
        p1: v2,
        d: point.distToLine3D(v1, v2),
        v: [face.b, face.c].sort(),
      };
      let l2 = {
        p0: v2,
        p1: v0,
        d: point.distToLine3D(v2, v0),
        v: [face.c, face.a].sort(),
      };
