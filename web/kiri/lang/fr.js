...
kiri.lang['fr-fr'] = {
    ...
    clear:          "débarrasser",  // clear workspace (remove all objects)
    copy:           "copier",
    delete:         "supprimer",
    detail:         "détail",
    done:           "terminé",
    ...
    acct_xpo:       ["faites un sauvegarde de votre machine","et des profils des machines avec","l'option d'inclure les","objets et positions d'environnement"],

    // RIGHT-CLICK CONTEXT MENU
    rc_clws:        "débarrasser l'environnement",
