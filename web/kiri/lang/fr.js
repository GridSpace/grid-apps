...
kiri.lang['fr'] = kiri.lang['fr-fr'] = {
  ...
  acct_xpo: [
    'faites une sauvegarde de votre machine',
    'et des profils des machines avec',
    "l'option d'inclure les",
    "objets et positions d'environnement",
  ],
  ...
  dv_bedh_l: [
    ...
    "en unités de l'espace de travail",
  ],
  ...
  dv_strc_l: [
    'éliminer les commentaires du gcode',
  ...
  op_sped_l: [
    'afficher la vitesse en barre de couleur',
    'en mode prévisualisation',
  ],
  op_auto_s: 'disposition automatique',
  op_auto_l: [
    'disposition automatique sur le plateau',
    'lorsque de nouveaux éléments sont ajoutés',
  ],
  op_free_s: 'disposition libre',
  op_free_l: [
    'autoriser la disposition déplaçable',
    'sans effet en mode laser',
  ],
  op_spcr_s: 'espacement',
  op_spcr_l: [
    'espacement entre les objets',
    'avec la disposition automatique',
    "en unités d'espace de travail",
  ],
  op_invr_s: 'inverser zoom',
  op_invr_l: ['inverser la molette de la souris', 'faire défiler le zoom'],
  op_save_s: 'auto enregt',
  op_save_l: [
    "préserve les objets dans l'espace de travail",
    "entre rechargement de l'application",
  ],
  op_line_s: 'type de ligne',
  op_line_l: [
    'style de ligne pour le rendu',
    'impacte les performances 3d',
    'chemin: 3d meilleur',
    'plat: 2d bon',
    'ligne = 1d rapide',
  ],
  op_unit_s: 'unités',
  op_unit_l: [
    "les unités d'espace de travail affectent",
    'vitesses et distances',
  ],
  op_anim_s: 'animer',
  op_anim_l: [
    "densité du maillage de l'animation",
  ...
  pt_deci_l: [
    ...
    "durant l'importation. Tranchage plus rapide",
    'et usage réduit de la mémoire',
  ],
  pt_qual_s: 'qualité',
  pt_qual_l: [
    'niveau de détail à garder',
    'lors des opérations de tranchage',
    'plus bas = plus rapide',
  ],
  pt_heal_s: 'correction de maillage',
  pt_heal_l: [
    'tentative de correction',
    'des mailles non-fermées',
    'accroit le temps de tranchage',
  ],
  ...
  ad_minl_l: [
    'hauteur de couche minimale adaptative',
    'en millimètres',
    'doit être non nulle',
  ],
  ...
  sl_ltop_l: [
    ...
    'à appliquer en',
    "haut de l'impression",
  ],
  sl_lsld_s: 'couches solides',
  sl_lsld_l: [
    'zones de remplissage solide calculées',
    'à partir des deltas de couches. voir',
    'menu surgissant des couches',
  ],
  ...
  ad_adap_s: 'adaptive',
  ad_adap_l: [
    'utiliser des hauteurs de couche adaptatives',
    "avec 'hauteur de couche' en maximum",
    "et 'hauteur min' en minimum",
  ],
  ...
  fi_angl_l: [
    ...
    '90 degrés ajoutés à ',
    'chaque couche suivante',
    "s'applique uniquement aux couches solides",
  ],
  fi_over_s: 'chevauchement',
  fi_over_l: [
    "chevauchement de l'enveloppe et du remplissage",
    'en tant que fraction du diamètre de la buse',
    '0,0 - 1,0',
  ],
  // fi_rate_s:      "vitesse d'impression",
  fi_rate_l: [
    "vitesse d'extrusion du remplissage",
    'régler à 0 pour utiliser par défaut',
  ...
  fl_lahi_l: [
    ...
    'en millimètres',
    'devrait être >= hauteur de la couche',
  ],
  fl_rate_s: 'vitesse périmètres',
  fl_rate_l: [
    "vitesse maximale d'impression des coques",
    'en millimètres / seconde',
  ],
  fl_frat_s: 'vitesse remplissage',
  fl_frat_l: [
    "vitesse maximale d'impression du remplissage",
    'en millimètres / seconde',
  ],
  fl_mult_s: 'débit',
  ...
  fl_sfac_s: 'largeur',
  fl_sfac_l: [
    'multiplicateur de la taille de la buse',
    "modifie l'espacement des lignes",
  ],
  fl_skrt_s: 'jupe nb',
  fl_skrt_l: [
    'nombre de lignes de la jupe',
    'à générer pour la première couche',
  ],
  ...
  fl_nozl_l: [
    'degrés en Celsius',
    'réglage de sortie utilisé',
    'lorsque celui-ci est égal à zéro',
  ],
  ...
  fr_spac_l: [
    'espacement des couches supplémentaires',
    'entre la 1ère couche et le radeau',
    'en millimètres',
  ],
  fr_nabl_s: 'activer un radeau',
  fr_nabl_l: [
    'créer un radeau sous le ',
    'modèle pour une meilleure adhérence',
    'utilise le décalage des jupes et',
    'désactive la sortie des jupes',
  ],

  // FDM BELT ONLY
  fl_zoff_s: 'décalage bande',
  fl_zoff_l: [
    'décalage de hauteur par rapport à la bande',
    "de l'extrusion la plus basse",
    'en millimètres',
  ],
  fl_brim_s: 'taille de bordure',
  fl_brim_l: [
    'ajoute une bordure à la partie inférieure',
    'la taille est la largeur en millimètres',
    '0 désactive',
  ],
  fl_brmn_s: 'seuil de bordure',
  fl_brmn_l: [
    'ajout de bordures uniquement quand le segment',
    'face à la bande est plus court que cela',
    'valeur en millimètres',
    '0 = infini',
  ],
  fl_bled_s: 'ancrage de pièce',
  fl_bled_l: [
    'ancrage de la pièce sur la bande',
  ...
  sp_span_l: [
    'portée non soutenue nécessitant',
    'un nouveau soutien à générer',
    'en millimètres',
  ],
  sp_angl_s: 'angle max',
  sp_angl_l: [
    'angle de surplomb maximum avant',
    'de générer un pilier de soutien',
  ],
  sp_area_s: 'surface min',
  sp_area_l: ['surface minimale de', 'la colonne support', 'en millimètres'],
  sp_xpnd_s: 'étendre',
  sp_xpnd_l: [
    'étendre la zone de soutien',
    "au-delà des limites d'une pièce",
    'en millimètres',
  ],
  sp_nozl_s: 'extrudeur',
  sp_nozl_l: [
    'dans les systèmes multi-extrudeurs',
    "l'extrudeur à utiliser pour",
    'le matériau de support',
  ],
  sp_auto_s: 'automatique',
  sp_auto_l: [
    'activer les supports générés',
    'utiliser la géométrie at-slice-time',
    "les supports n'apparaîtront",
    "qu'une fois le tranchage terminé",
  ],
  ...
  ou_feed_l: ["vitesse d'impression maximale", 'millimètres / seconde'],
  ou_fini_s: 'vitesse coque',
  ou_fini_l: ['vitesse de la coque extérieure', 'millimètres / seconde'],
  ou_move_s: 'vitesse déplacement',
  ou_move_l: [
    'vitesse de déplacement sans impression',
    'millimètres / seconde',
    '0 = active déplacements G0',
  ],
  ...
  ad_rdst_l: [
    'longueur de filament à rétracter',
    'pour les longs mouvements. en millimètres',
  ],
  ...
  ad_wpln_l: [
    'mouvement sans impression',
    'après rétraction',
    'en millimètres',
  ],
  ad_rdwl_l: [
    'durée de réenclenchement',
    'filament et mouvement',
    'en millisecondes',
  ],
  ad_scst_s: 'cabotage',
  ad_scst_l: [
    'extrémité non imprimée',
    'des coques du périmètre',
    'en millimètres',
  ],
  ad_msol_s: 'min solide',
  ad_msol_l: [
    'aire minimale (mm^2)',
    'requise pour rester solide',
    'doit être > 0.1',
  ],
  ...
  ad_spol_l: [
    'les polygones plus courts',
    'auront la vitesse réduite et',
    'seront ramenés à la vitesse minimale',
    'en millimètres',
  ],
  ad_arct_s: 'tolérance arc',
  ad_arct_l: [
    'convertir les lignes des facettes en arcs',
    'tolérance de dérive du point central',
    "lors de la correspondance des points d'arc",
    'considérer les valeurs autour de 0,15',
    'en millimètres',
    '0 désactive',
  ],
  ...
  ad_zhop_l: [
    'levée du z',
    'sur les mouvements de rétraction',
    'en millimètres',
    '0 désactive',
  ],
  ad_abkl_s: 'anti-backlash',
  ad_abkl_l: [
    'pour une meilleure finition de la surface plane',
    'utiliser des micro-mouvements pour annuler',
    'le jeu dans la sortie de la couche solide',
    'en millimètres',
    '0 désactive',
    'si le firmware reconnait le M425',
    "l'utiliser dans l'en-tête du gcode",
    'et mettre à 0',
  ],
  ...
  ag_paws_l: [
    'liste de couches séparées par des virgules',
    'pour injecter des commandes de pause avant',
  ],
  ag_loop_s: 'couches de répétitions',
  ag_loop_l: [
    'des plages de couches à répéter dans le format ',
    'premier-compte dernier,premier-compte dernier,...',
    'compte omis = 1',
  ],
