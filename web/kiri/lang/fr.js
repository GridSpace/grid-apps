...
self.lang['fr-fr'] = {
    ...
    fl_rate_l:      ["vitesse maximale d'impression des coques", "en millimètres / seconde"],
    fl_frat_s:      "vitesse remplissage",
    fl_frat_l:      ["vitesse maximale d'impression du remplissage", "en millimètres / seconde"],
    fl_mult_s:      "débit",
    ...
    ou_move_l:      ["vitesse de déplacement sans impression","millimètres / seconde","0 = active déplacements G0"],
