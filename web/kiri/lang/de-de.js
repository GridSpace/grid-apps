...
kiri.lang['de'] = kiri.lang['de-de'] = {
  ...
  acct_xpo: [
    'Lege ein Backup Deiner Geräte',
    'und Geräte-Profile an, mit der',
    'Option, den Arbeitsbereich und',
    'mit Objekten und Anordnung zu speichern',
  ],
  ...
  dv_spmx_l: [
    'Maximale Umdrehungen pro Minute der Spindel',
    '0 zum deaktivieren',
  ],
  ...
  dv_prog_l:
    'Wenn für jedes % der Fertigstellung eine Nachicht angezeigt werden soll',
  dv_layr_s: 'Ebene',
  dv_layr_l: ['Ausgabe bei jeder', 'neuen Ebene'],
  dv_tksp_s: 'Befehls-Trenner',
  dv_tksp_l: [
    'Füge ein Leerzeichen ein bei',
    'GCode-Achsen-Befehlen',
    'G0X0Y0X0',
    'oder',
    'G0 X0 Y0 Z0',
  ],
  ...
  op_sped_l: [
    'Zeige Legende für Farben und Geschwindigkeiten',
    'in der Vorschau',
  ],
  ...
  op_free_l: [
    'Erlaube Freie Anordnung von Objekten',
    'Keine Auswirkung im Laser-Cutting Arbeitsmodus',
  ],
  op_spcr_s: 'Abstand',
  op_spcr_l: [
    'Abstand zwischen Objekten',
    'bei automatischer Anordnung',
    'in Maßeinheiten der Arbeitsfläche',
  ],
  op_invr_s: 'Zoom Umkehren',
  op_invr_l: ['Kehre die Richtung beim Mausrad-', 'Zoomen um'],
  op_save_s: 'Automatisch speichern',
  op_save_l: [
    'Behalte Objekte im Arbeitsbereich',
    'wenn die Anwendung neu geladen wird',
  ],
  op_line_s: 'Darstellungs-Typ',
  op_line_l: [
    'Wie Linien bei der Darstellung der Pfade gezeichnet werden',
    'Beeinflußt 3D-Performance',
    'Pfad: 3D (beste)',
    'Flach: 2d (gut)',
    'Linie = 1d (schnell)',
  ],
  ...
  op_unit_l: [
    'die Maßeinheit des Arbeitsbereich wirkt sich auf die Darstellung von ',
    'Geschwindigkeiten und Entfernungen aus',
  ],
  op_anim_s: 'Animieren',
  op_anim_l: [
    'Dichte des Netzgitters beim Animieren',
  ...
  pt_deci_l: [
    'Punktdezimierung',
    'während des Imports. Für schnelleres Slicen',
    'und weniger Speicherverbrauch',
  ],
  pt_qual_s: 'Qualität',
  ...
  pt_heal_l: [
    'Versuche',
    'defekte Meshes zu reparieren',
    'wirkt sich auf die Verarbeitungszeit us',
  ],
  ...
  ad_minl_l: [
    'Mindesthöhe für adaptive Schichthöhe',
    'in mm',
  ...
  sl_lbot_l: [
    'Anzahl der soliden Schichten',
    'um die Unterseite des',
    'Drucks zu verstärken',
  ],
  ad_adap_s: 'Adaptive Höhe',
  ad_adap_l: [
    'Verwende adaptive Schichthöhe',
    "mit 'Maximale Höhe' als Maximum",
    "und 'Mindesthöhe' als Minimum",
  ],
  ...
  sl_ordr_l: [
    'In welcher Reihenfolge die Wände gedruckt werden',
    'innen nach aussen',
    'oder aussen nach innen',
    'wirkt sich auf die Oberflächenqualität aus',
  ],
  sl_strt_s: 'Start der Ebene',
  sl_strt_l: [
    'Startpunkt der Ebene',
    'Letzte = Ende der letzten Ebene ',
    'Mitte = Zur Mitte des Objekts',
    'Nullpunkt = Zum Nullpunkt des Gerätes',
  ],
  ...
  fi_angl_l: [
    'Startwinkel in Grad',
    '90 Grad werden ',
    'bei jeder folgender Schicht dazugerechnet',
    'Wirkt sich nur auf vollgefüllte Schichten aus.',
  ],
  fi_over_s: 'Schicht-Überlappung',
  fi_over_l: [
    'Überlappung von Schichten und Füllung',
    'als Anteil des Düsen-Durchmessers',
    '0.0 - 1.0',
  ],
  // fi_rate_s:      "print speed",
  fi_rate_l: [
    'Druckgeschwindigkeit für Füllmaterial',
    'Auf 0 setzen, um die Standard-',
    'Druckgeschwindigkeit zu verwenden',
  ],
  ...
  fl_lahi_l: [
    ...
    'in in mm',
    'sollte >= der Standard-Schichthöhe sein',
  ],
  ...
  fl_sfac_l: [
    'Multipliziert mit dem Düsenfaktor',
    'beeinflußt die Breite der Drucklinien',
  ],
  fl_skrt_s: 'Anzahl der Skirt-Linien',
  fl_skrt_l: [
    'Wieviele Linien um die erste Schicht',
  ...
  fl_nozl_l: [
    'in Grad Celsius',
    'Standard-Einstellung wird verwendet',
    'wenn auf 0 gestellt',
  ],
  ...
  fr_spac_l: [
    ...
    'zwischen erster Schicht und Raft',
    'in mm',
  ],
  fr_nabl_s: 'Raft verwenden',
  fr_nabl_l: [
    'Erzeuge ein Raft unter dem',
    'Objekt für bessere Betthaftung',
    'verwendet Skirt-Abstand und',
    'Deaktiviert die Erzeugung eines Skirt',
  ],
  ...
  fl_brim_l: [
    'Brim am Fuß des Objekts erzeugen',
    'Größe in mm',
    '0 um zu deaktivieren',
  ],
  fl_brmn_s: 'Brim-Auslöser',
  fl_brmn_l: [
    'Erzeuge nur Brim, wenn die Fläche',
    'auf dem Gurt kürzer ist als dieser Wert',
    'Angegeben in mm',
    '0 = Immer',
  ],
  ...
  sp_span_l: [
    'Für Spannen über dieser Breite',
    'werden Stützstrukturen erzeugt',
    'in mm',
  ],
  sp_angl_s: 'Maximaler Winkel',
  sp_angl_l: [
    'Für Überhänge über diesem Winkel',
    'werden Stützstrukturen erzeugt',
  ],
  ...
  sp_xpnd_s: 'Ausdehung',
  sp_xpnd_l: [
    'Dehne die Stützstruktur',
    'über die Objekt-Grenzen aus',
    'in mm',
  ],
  sp_nozl_s: 'Extruder',
  sp_nozl_l: [
    'In Geräten mit mehreren Extrudern',
    'welcher Extruder wird für',
    'Stützmaterial verwendet',
  ],
  sp_auto_s: 'Automatisch',
  sp_auto_l: [
    'Erzeuge Stützstrukturen automatisch',
    'beim Slicen',
    'Stützstruktuen werden erst',
    'Nach dem Slicen angezeigt',
  ],
  ...
  cr_lsto_l: [
    'horizontal Versatz from vertical faces',
  ...
  ou_move_l: [
    'Geschwindigkeit, wenn nicht gedruckt wird ',
    'mm / s',
    '0 = aktiviere G0 Befehle',
  ],
  ...
  ad_rdst_l: [
    'Wie weit das Filament eingezogen werden soll',
    'bei langen Bewegungen (in mm)',
  ],
  ...
  ad_rdwl_l: [
    ...
    'Bewegung und Vorschub nach Einzug ',
    'in msec',
  ],
  ad_scst_s: 'Außenwand-Coasting',
  ad_scst_l: [
    'Welche Strecke am Ende einer',
    'Außenwand nicht extrudiert wird',
    'in mm',
  ],
  ad_msol_s: 'Mindestfläche für vollständige Füllung',
  ad_msol_l: [
    'Mindestfläche in mm^2 ',
    'für vollständige Füllung',
    'muß > 0.1 sein',
  ],
  ...
  ad_spol_l: [
    'Segmente die kürzer sind',
    'werden mit',
    'Mindestgeschwindigkeit gedruckt',
    'in mm',
  ],
  ...
  ad_abkl_l: [
    'Für schöneres Aussehen Flacher Oberflächen',
    'verwende Micro-Bewegungen',
    'um Backlash auszugleichen',
    'in mm',
    '0 zum deaktivieren',
    'Wenn Deine Firmware M425 unterstützt',
    'verwende das im Start-GCode und setze hier auf 0',
  ],
  ...
  ag_paws_l: [
    'Liste von Ebenen (kommasepariert',
    'vor denen pausiert werden soll',
  ],
  ag_loop_s: 'Schichten wiederholen',
  ag_loop_l: [
    'Schichten die wiederholt werden sollen, im Format ',
    'erste-letzte-anzahl,erste-letzte-anzahl,...',
    'omitted count = 1',
  ],
  ...
  sa_shel_l: [
    'Wanddick mm',
    'verwene Mehrfaches der Schichthöhe',
  ...
  sa_obas_l: [
    'Wenn Aushöhlen aktiviert ist',
    'bleibt das Objekt unten offen',
    'deaktiviert, wenn Stützstrukturen verwendet werden',
  ],
