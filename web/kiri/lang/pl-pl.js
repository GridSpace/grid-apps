...
kiri.lang['pl'] = kiri.lang['pl-pl'] = {
  ...
  acct_xpo: [
    'zrób backup swojego urządzenia',
    'i profil urządzenia z',
    'opcja by zapisać przestrzeń roboczą',
    'obiekty i pozycje',
  ],
  ...
  dv_spmx_l: [
    'maksymalna prędkość wrzeciona w obrotach na minutę',
    '0 wyłączone',
  ],
  ...
  ag_loop_l: [
    'layer ranges to repeat in the format',
