...
const imageDescripts = {
    ...
    deviceInterface: [
        ['/fdm.png', 'FDM printer interface'],
        ['/cnc.png', 'CNC machine interface'],
        ['/laser.png', 'Laser Cutter interface'],
        ['/sla.png', 'SLA printer interface'],
    ],
    modePreferences: [
        ['/fdm.png', 'FDM mode prefrences'],
        ['/cnc.png', 'CNC mode prefrences'],
    ],
}
